<?php /* Smarty version Smarty-3.1.19, created on 2022-09-24 16:47:01
         compiled from "C:\xampp\htdocs\presta_test\admin770gzgmzk\themes\default\template\controllers\products\informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17157632cedfbc501e4-76145930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08652971d3b479cda648af768b1a386eaba85b30' => 
    array (
      0 => 'C:\\xampp\\htdocs\\presta_test\\admin770gzgmzk\\themes\\default\\template\\controllers\\products\\informations.tpl',
      1 => 1664030809,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17157632cedfbc501e4-76145930',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_632cedfbd9c616_65304864',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_632cedfbd9c616_65304864')) {function content_632cedfbd9c616_65304864($_smarty_tpl) {?>
...
" />
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="second_reference">
			<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo smartyTranslate(array('s'=>'Your second reference code'),$_smarty_tpl);?>
 <?php echo smartyTranslate(array('s'=>'Allowed special characters:'),$_smarty_tpl);?>
 .-_#\">
				<?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
 <?php echo smartyTranslate(array('s'=>'Reference bis'),$_smarty_tpl);?>

			</span>
		</label>
		<div class="col-lg-5">
			<input type="text" id="second_reference" name="second_reference" value="<?php echo smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['product']->value->second_reference);?>
" />
		</div>
	</div>
...
';
	...
	<div id="product_options" class="form-group">
		<div class="col-lg-12">
			...
			<div class="form-group">
				<div class="col-lg-1"><span class="pull-right"><?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('field'=>"delivery",'type'=>"radio",'onclick'=>''), 0);?>
</span></div>
				<label class="control-label col-lg-2">
				...
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="delivery" id="delivery_on" value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->delivery||!$_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()) {?>checked="checked" <?php }?> />
						<label for="delivery_on" class="radioCheck">
							<?php echo smartyTranslate(array('s'=>'Yes'),$_smarty_tpl);?>

						</label>
						<input type="radio" name="delivery" id="delivery_off" value="0" <?php if (!$_smarty_tpl->tpl_vars['product']->value->delivery&&$_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()) {?>checked="checked"<?php }?> />
						<label for="delivery_off" class="radioCheck">
							<?php echo smartyTranslate(array('s'=>'No'),$_smarty_tpl);?>
