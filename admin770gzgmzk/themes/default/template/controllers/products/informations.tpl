...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="second_reference">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Your second reference code'} {l s='Allowed special characters:'} .-_#\">
				{$bullet_common_field} {l s='Reference bis'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div id="product_options" class="form-group">
		<div class="col-lg-12">
			...
			<div class="form-group">
				<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="delivery" type="radio" onclick=""}</span></div>
				<label class="control-label col-lg-2">
					{l s='Delivery'}
				</label>
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="delivery" id="delivery_on" value="1" {if $product->delivery || !$product->isAssociatedToShop()}checked="checked" {/if} />
						<label for="delivery_on" class="radioCheck">
							{l s='Yes'}
						</label>
						<input type="radio" name="delivery" id="delivery_off" value="0" {if !$product->delivery && $product->isAssociatedToShop()}checked="checked"{/if} />
